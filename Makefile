...
ARCHIVO_ENTREGA=Entrega2.tar.gz

ENTREGAR = pila lista producto vencimiento colProductos deposito gestionDeposito  


MODULOS = $(ENTREGAR) utils fecha controlFecha cadena
